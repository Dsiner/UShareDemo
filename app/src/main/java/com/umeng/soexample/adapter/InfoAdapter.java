...
import com.umeng.soexample.InfoDetailActivity;
 ...
 */
public class InfoAdapter extends CommonAdapter<PlatformBean> {

    public InfoAdapter(Context context, List<PlatformBean> datas, int layoutId) {
