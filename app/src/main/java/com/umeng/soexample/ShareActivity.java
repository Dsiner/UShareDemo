...
import com.umeng.soexample.adapter.ShareAdapter;
...
public class ShareActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lrvList.setAdapter(new ShareAdapter(this, getDatas(), R.layout.adapter_item));
    }
    ...
    public List<PlatformBean> getDatas() {
        ...
        platforms.add(new PlatformBean(R.drawable.umeng_socialize_qzone, "QQ空间", SHARE_MEDIA.QZONE));
        platforms.add(new PlatformBean(R.drawable.umeng_socialize_wechat, "微信", SHARE_MEDIA.WEIXIN));
        platforms.add(new PlatformBean(R.drawable.umeng_socialize_wxcircle, "朋友圈", SHARE_MEDIA.WEIXIN_CIRCLE));
